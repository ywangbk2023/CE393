...
C {sky130_stdcells/inv_1.sym} -1030 270 0 0 {name=x3 VGND=VSS VNB=VNB VPB=VPB VPWR=VDD prefix=sky130_fd_sc_hd__ }
...
C {devices/opin.sym} -950 -100 0 0 {name=p3 lab=Updown}
...
C {devices/lab_pin.sym} -950 110 0 1 {name=p25 sig_type=std_logic lab=Updown}
