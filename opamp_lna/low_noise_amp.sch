...
C {sky130_fd_pr/pfet_01v8.sym} 540 -810 0 1 {name=M4
L=0.15
W=1
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 500 -650 0 0 {name=M6
L=0.15
W=1
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 1380 -650 0 1 {name=M10
L=0.15
W=1
nf=1 
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 580 -280 3 1 {name=M15
L=0.15
W=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 420 -280 3 1 {name=M16
L=0.15
W=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 970 -280 1 0 {name=M17
L=0.15
W=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 1130 -280 1 0 {name=M18
L=0.15
W=1
nf=1
mult=1
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 740 -170 0 0 {name=C1 model=cap_mim_m3_1 W=1 L=1 MF=1 spiceprefix=X}
...
C {devices/lab_pin.sym} 740 -80 0 0 {name=p14 sig_type=std_logic lab=VSS}
...
C {devices/lab_pin.sym} 1270 -260 0 1 {name=p21 sig_type=std_logic lab=V1N}
C {devices/lab_pin.sym} 290 -260 0 0 {name=p22 sig_type=std_logic lab=V1P}
C {devices/iopin.sym} 780 -320 0 0 {name=p23 lab=Vcm_out}
C {devices/lab_pin.sym} 260 -970 0 0 {name=p24 sig_type=std_logic lab=Vbias}
C {devices/lab_pin.sym} 660 -740 0 1 {name=p25 sig_type=std_logic lab=CMFB}
