...
N -170 80 -170 100 {
lab=GND}
C {devices/code_shown.sym} -620 180 0 0 {name=s1 only_toplevel=false value="
...
C {devices/vsource.sym} -320 250 0 0 {name=V1 value=1.0 savecurrent=false}
